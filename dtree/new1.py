...
X=int(wight/10)
Y=int(height/10)
end = endx, endy = 3,4 ##cel śmieciarki

## rodzaj pola zależnie od jego wartości w tabeli tab[][]
## -1,-2,-3 - wysypiska śmieci. [0,1] - trawa, 2 - droga, - 3 domek, 4 - drzewa 
...
'''
#heurystyka
#heurystyka odwołuje się do Manhattan Distance między start a end
...
#generowanie i wybieranie sąsiednich pól
